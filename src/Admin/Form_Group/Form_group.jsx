  ...
  return (
    <div className="create_Account">
      ...
      <div className="input_Content">
        ...
        <div className="input_Box_check">
          <div className="check">
           <Para value={"Org Admin"}/>
           <Input type={"checkbox"} className={"form_input"}  placeholder={"e.g.India"}/>
           </div>
        </div>
        <div className="input_Box_check">
          <div className="check">
        ...
        <div className="input_Box_radio">
           <Para value={"Select User Type"} />
            <span>
               <div className="radio">
                  <Input type={"radio"} nam="radio" className={"form_input"}  placeholder={"e.g.India"}/>
                  <Para value={"Manager"}/>
               </div>
               <div className="radio">
                  <Input type={"radio"} nam="radio"  className={"form_input"}  placeholder={"e.g.India"}/>
                  <Para value={"Maintainer"}/>
               </div>
            </span>
        </div>
        <div className="input_Box">
